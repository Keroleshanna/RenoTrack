...
public sealed class FakeEmailSender : IEmailSender
{
    ...
    public List<AngebotDecisionNotification> AngebotDecisionNotifications { get; } = [];
    public List<InvoiceReadyNotification> InvoiceReadyNotifications { get; } = [];
