...
- **`feature/phase-9-email-integration` is the current branch**, branched off `main` at `d7ae2f0`, carrying the six Phase 9 commits. **It is local only — never pushed, no upstream configured, and no PR exists.**
