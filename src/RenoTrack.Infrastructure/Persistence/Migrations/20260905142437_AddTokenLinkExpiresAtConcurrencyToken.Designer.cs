...
namespace RenoTrack.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260905142437_AddTokenLinkExpiresAtConcurrencyToken")]
    partial class AddTokenLinkExpiresAtConcurrencyToken
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RenoTrack.Domain.Entities.Project", b =>
                {
                    ...
                    b.Property<decimal>("AgreedTotal")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("RenoTrack.Infrastructure.Persistence.Entities.NotificationDelivery", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RenoTrack.Domain.Entities.Project", b =>
                {
                    ...
                    b.HasOne("RenoTrack.Domain.Entities.Customer", null)
                        .WithMany()
